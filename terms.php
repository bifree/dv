...
<head prefix="og: http://ogp.me/ns#">
    ...
    <meta name="description" content="能力探究塾-DaVinci-の利用規約がご覧いただけます。">
    <title>利用規約 | DaVinci-ダヴィンチ-</title>  
    <!-- OGP -->
    <meta property="og:title" content="利用規約 | DaVinci-ダヴィンチ-">
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://www.davinci-tanq.com/terms.php">
    <meta property="og:site_name" content="能力探究塾-DaVinci-" />
    <meta property="og:description" content="能力探究塾-DaVinci-の利用規約がご覧いただけます。" />
...
<body>
    ...
    <div class="wrapper">
        <h1 class="title_inner">利用規約</h1>
        <div class="container-midium container_terms">
            <ul class="list_terms">
                <li><a class="text-midium" href="privacypolicy.php">プライバシーポリシー</a></li>
                <li><a class="text-midium" href="tokushoho.php">特定商取引法に基づく表記</a></li>
                <li><a class="text-midium selected" href="terms.php">利用規約</a></li>
            </ul>
            <div class="container_treaty">
                <div>
                    この利用規約（以下，「本規約」といいます。）は，bring up株式会社（以下，「当社」といいます。）が提供する能力探究塾DaVinci（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。  
                </div>
                
                <h2 class="text-large">第1条（適用）</h2>
                <div>
                ...
                <h2 class="text-large">第2条（利用登録）</h2>
                <div>
                    <ul class="list-number">
                        <li>本サービスにおいては，登録希望者が本規約に同意の上，当社の定める方法によって利用登録を申請し，当社がこれを承認することによって，利用登録が完了するものとします。</li>
                        <li>お客様が未成年者である場合は、親権者など法定代理人の同意（本規約への同意を含みます）を得たうえで本サービスをを利用してください。また、本契約に同意した時点で未成年者であったお客様が、成年に達した後に本サービスを利用した場合、未成年者であった間の利用行為を追認したものとみなします。</li>                    
                ...
                <h2 class="text-large">第3条（ユーザーIDおよびパスワードの管理）</h2>
                <div>
                    <ul class="list-number">
                ...
                <h2 class="text-large">第6条（本サービスの提供の停止等）</h2>
                <div>
                ...
                <h2 class="text-large">第7条（利用制限および登録抹消）</h2>
                <div>
                ...
                <h2 class="text-large">第8条（退会）</h2>
                <div>
                    ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。
                </div>
        
                <h2 class="text-large">第9条（保証の否認および免責事項）</h2>
                <div>
                    <ul class="list-number">
